       ...
       public static void Main_Part1(string[] args)
        {
         ...
         //   Employee[] arr = empArr.Where((Employee e) => e.Id > 3 && !e.Name.Contains("A", StringComparison.OrdinalIgnoreCase)).ToArray();
            ...
            Employee[] areE = GetCollection<Employee>(empArr, (e) => e.Id > 3).ToArray();
            Employee[] areE2 = GetCollection<Employee>(empArr, (e)=> !e.Name.Contains("A", StringComparison.OrdinalIgnoreCase)).ToArray();
